...
Disclaimer: The steps below are pretty invasive and do not guarantee success. It is recommended to test on a [virtualized OpenWrt](https://github.com/graysievert/Homelab-010_DNS_x509CA/blob/master/110-openwrt_on_proxmox.md) first. 
I'm starting right after configuring [dynamic DNS updates on my OpenWRT router](https://github.com/graysievert/Homelab-010_DNS_x509CA/blob/master/120-bind_on_openwrt.md), but this guide is self-sufficient if you already have control over name resolution in your network.
